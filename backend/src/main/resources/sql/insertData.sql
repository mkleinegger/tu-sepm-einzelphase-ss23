...
(-2, 'Romeo', 'Handsome stallion with a bay coat and a white blaze', '2016-08-11', 'MALE', -7, NULL, NULL),
(-3, 'Sophie', 'Gentle mare with a chestnut coat and a white blaze', '2014-06-02', 'FEMALE', NULL, NULL, NULL),
(-4, 'Daisy', 'Sweet mare with a chestnut coat and white socks', '2017-03-10', 'FEMALE', NULL, -3, -2),
(-5, 'Spirit', 'Gentle grey stallion with a long mane', '2015-11-22', 'MALE', -3, NULL, NULL),
(-6, 'Bella', 'Elegant mare with a dappled grey coat', '2019-02-01', 'FEMALE', -4, -4, -1),
(-7, 'Max', 'Playful colt with a chestnut coat and a white star', '2020-09-05', 'MALE', NULL, NULL, -5),
(-8, 'Luna', 'Curious filly with a black coat and white stockings', '2021-02-18', 'FEMALE', -6, -6, -5),
(-9, 'Apollo', 'Powerful stallion with a black coat and a muscular build', '2017-09-19', 'MALE', -9, NULL, NULL),
(-10, 'Misty', 'Shy mare with a palomino coat and a long mane', '2018-12-07', 'FEMALE', -10, -3, -2);
